Ext.define('ExtJS5.controller.Main', {
	    					...
	    					success : function(form, action){
	                            ...
	                            var cmp = Ext.create('Ext.Viewport', {
	                                ...
	                                loader: {
	                                    ...
	                                    success: function(){
	                                		ExtJS5.getApplication().getController('MainMenu');
	                                		ExtJS5.getApplication().getController('MainContainer');
	                                	}
	                                }
	                            });
    ...
    onPanelRender: function(){
    	console.info(this.counterTmpl.apply({count: ++ExtJS5.controller.Main.counter}));
    },//onPanelRender
});
