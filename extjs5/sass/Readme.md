...
folder are mapped to the application's root namespace, 'ExtJS5'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ExtJS5' in the same way
as `"ExtJS5/sass/src"`.
