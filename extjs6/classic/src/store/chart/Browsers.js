Ext.define('ExtJS6.store.chart.Browsers', {
    extend: 'Ext.data.Store',
    alias: 'store.chart.browsers',
    ...
    constructor: function (config) {
        ...
        config.data = [
            { month: 'Jan', data1: 50, data2: 37, data3: 35, data4: 4, other: 4 },
            ...
            { month: 'Jun', data1: 17, data2: 84, data3: 42, data4: 4, other: 3 },
            ...
            { month: 'Nov', data1: 25, data2: 31, data3: 46, data4: 4, other: 4 },
            { month: 'Dec', data1: 15, data2: 31, data3: 47, data4: 4, other: 32 }
        ];
