Ext.define('ExtJS4.controller.Main', {
	    					...
	    					success : function(form, action){
	                            ...
	                            var cmp = Ext.create('Ext.Viewport', {
	                                ...
	                                loader: {
	                                    ...
	                                    success: function(){
	                                		ExtJS4.getApplication().getController('MainMenu');
	                                		ExtJS4.getApplication().getController('MainContainer');
	                                	}
	                                }
	                            });
    ...
    onPanelRender: function(){
    	console.info(this.counterTmpl.apply({count: ++ExtJS4.controller.Main.counter}));
    },//onPanelRender
});
